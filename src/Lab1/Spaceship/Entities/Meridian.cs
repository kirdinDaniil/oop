...
public class Meridian : ISpaceship
{
    ...
    public Meridian(bool haveDeflectorModification)
    {
        _deflector = new DeflectorSecondClass(haveDeflectorModification ? new PhotonDeflectorModification() : null);
        _hull = new HullSecondClass();
        Engine = new ImpulseEngineClassE();
        JumpEngine = null;
        HaveAntiNitrineEmitter = true;
        IsCrewDead = false;
    }
